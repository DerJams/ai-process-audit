...
DISCLOSURE = (
    ...
    "fixed rubric and ranks the results. It has not visited the "
...
def _context(result: AuditResult, generated_on: date | None) -> dict:
    ...
    if result.disqualified:
        warnings.append(
            _plural_word(len(result.disqualified), "process", "processes")
            + " left the ranking entirely because software cannot perform the work. "
            "They are listed after the rankings."
        )
