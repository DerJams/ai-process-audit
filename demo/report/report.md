...
Generated 2026-08-08 against rubric 1.3.0-draft by judge `stub-heuristic-v1` in stub mode.

## In short

**Getting artwork approved by the customer** is the strongest candidate of the 5 processes reviewed, scoring 3.65 out of 5.00 and landing in Worth a pilot. What puts it top is pain: The business describes mistakes and rework, delays and chasing, and the strain on staff across a process that changes hands 1 time.
The thing most likely to stop it is implementation risk, scored 5 out of 5.

> This report was generated by an AI system. It scores each process against a fixed rubric of six criteria and ranks the results. It has not visited the business, spoken to anyone, or checked any of the figures it was given. Treat every finding as a starting point for a human review, not as a decision.
...
- Rubric 1.3.0-draft is a draft and has not been approved, so the weights behind these rankings are still open to change.
...
| --- | --- | --- | --- | --- |
| 1 | Getting artwork approved by the customer | Worth a pilot | 3.65 | Implementation risk (5/5) |
| 2 | Quoting trade and retail work | Worth a pilot | 3.45 | Implementation risk (5/5) |
| 3 | Closing out installation paperwork | Worth a pilot | 3.15 | Implementation risk (4/5) |
| 4 | Scheduling the press floor | Worth a pilot | 3.15 | Implementation risk (4/5) |
| 5 | Reordering print media and vinyl | Worth a pilot | 3.10 | Pain (2/5) |
...
Scores run from 1.00 to 5.00. Bands are set in rubric 1.3.0-draft:
...
Each process is scored from 1 to 5 on 6 criteria. Five point the same way, where a higher score means a better candidate. Implementation risk points the other way, so it is inverted before the weighted score is worked out. The inversion is done by the engine, not by the judge.

| Criterion | Weight | Direction |
| --- | --- | --- |
| Pain | 0.20 | higher is better |
| Frequency | 0.15 | higher is better |
| Volume | 0.15 | higher is better |
| Data availability | 0.20 | higher is better |
| Implementation risk | 0.15 | higher is worse, inverted by the engine |
| Return band | 0.15 | higher is better |
...
**Worth a pilot, weighted score 3.65.**
...
| --- | --- | --- | --- |
| Pain | 4/5 | 0.20 | The business describes mistakes and rework, delays and chasing, and the strain on staff across a process that changes hands 1 time. |
| Frequency | 5/5 | 0.15 | Stated frequency of daily works out at about 250 runs a year. |
| Volume | 4/5 | 0.15 | About 4,500 proofs a year, from 18 proofs a day. The business gave this as an estimate. |
| Data availability | 3/5 | 0.20 | The records sit in the shared drive in a mostly consistent shape, though some of the input still arrives in a form that has to be handled by hand first. |
| Implementation risk (inverted) | 5/5 | 0.15 | This process is flagged as handles money, the work is mixed, a couple of cases in ten need handling differently, and an error would be seen by a customer rather than caught inside the business. |
| Return band | 5/5 | 0.15 | About 1,056 hours a year go into this process, from 22 hours a week over 48 working weeks. The business already tracks: average days from proof sent to approval, tracked in the production spreadsheet, currently about three. |


Strongest part of the case: pain. Most likely to stop it: implementation risk.
...
**Worth a pilot, weighted score 3.45.**
...
| Criterion | Score | Weight | Rationale |
| --- | --- | --- | --- |
| Pain | 2/5 | 0.20 | The business describes delays and chasing. |
| Frequency | 5/5 | 0.15 | Stated frequency of daily works out at about 250 runs a year. |
| Volume | 4/5 | 0.15 | About 3,000 quotes a year, from 12 quotes a day. The business gave this as an estimate. |
| Data availability | 4/5 | 0.20 | Excel holds this in structured fields, though some of the input still arrives in a form that has to be handled by hand first. |
| Implementation risk (inverted) | 5/5 | 0.15 | This process is flagged as handles money, the work is judgment heavy, a large minority of cases need handling differently, and an error would be seen by a customer rather than caught inside the business. |
| Return band | 5/5 | 0.15 | About 960 hours a year go into this process, from 20 hours a week over 48 working weeks. Minutes per item across the year would suggest 1,250 hours, so the two figures given do not fully agree. The business already tracks: quotes sent per day and total quoted value, logged in the quotes tab. |
...
**Worth a pilot, weighted score 3.15.**
...
| Criterion | Score | Weight | Rationale |
| --- | --- | --- | --- |
| Pain | 2/5 | 0.20 | The business describes customers feeling it. |
| Frequency | 4/5 | 0.15 | Stated frequency of several times per week works out at about 150 runs a year. |
| Volume | 3/5 | 0.15 | About 468 installs a year, from 9 installs a week. |
| Data availability | 4/5 | 0.20 | QuickBooks Online holds this in structured fields, though some of the input still arrives in a form that has to be handled by hand first. |
| Implementation risk (inverted) | 4/5 | 0.15 | This process is flagged as handles money and legally binding, the work is rule based, almost every case follows the same path, and an error would be seen by a customer rather than caught inside the business. |
| Return band | 4/5 | 0.15 | About 273 hours a year go into this process, from 35 minutes per item over 468 items a year. The business already tracks: days from install to invoice, visible in QuickBooks Online, currently averaging ten. |
...
| Pain | 2/5 | 0.20 | The business describes delays and chasing. |
| Frequency | 5/5 | 0.15 | Stated frequency of daily works out at about 250 runs a year. |
| Volume | 4/5 | 0.15 | About 7,500 live jobs a year, from 30 live jobs each run. The business gave this as an estimate. |
| Data availability | 4/5 | 0.20 | Onyx RIP software holds this in structured fields, though some of the input still arrives in a form that has to be handled by hand first. |
| Implementation risk (inverted) | 4/5 | 0.15 | Nothing about money, regulation, or safety was flagged, and the map shows the work running straight through without a checking step, the work is judgment heavy, a large minority of cases need handling differently, and an error would be caught inside the business as rework. |
| Return band | 2/5 (capped from 4) | 0.15 | About 336 hours a year go into this process, from 7 hours a week over 48 working weeks. The business tracks no number for this process today, so any saving could be claimed but not shown. |
...
**Worth a pilot, weighted score 3.10.**
...
| Criterion | Score | Weight | Rationale |
| --- | --- | --- | --- |
| Pain | 2/5 | 0.20 | The business describes mistakes and rework. |
| Frequency | 4/5 | 0.15 | Stated frequency of weekly works out at about 52 runs a year. |
| Volume | 4/5 | 0.15 | About 1,300 line items a year, from 25 line items a week. The business gave this as an estimate. |
| Data availability | 3/5 | 0.20 | The records sit in spreadsheets or email in a mostly consistent shape, though some of the input still arrives in a form that has to be handled by hand first. |
| Implementation risk (inverted) | 2/5 | 0.15 | Nothing about money, regulation, or safety was flagged, and the map shows 1 checking step along the way, the work is mixed, a couple of cases in ten need handling differently, and an error would be caught inside the business as rework. |
| Return band | 2/5 (capped from 3) | 0.15 | About 96 hours a year go into this process, from 2 hours a week over 48 working weeks. The business tracks no number for this process today, so any saving could be claimed but not shown. |
...
Strongest part of the case: data availability. Most likely to stop it: pain.
...
This report came from a fixed pipeline. The intake was validated against a JSON Schema, normalised into an internal model, read into a process map by a rule based parser, scored one criterion at a time against rubric 1.3.0-draft, and ranked by weighted score. Every stage except the scoring is deterministic, and the same intake produces the same report every time.
...
- The weights in the rubric are a judgement about what matters, and reasonable people would set them differently. They are recorded in rubric 1.3.0-draft so they can be argued with.
